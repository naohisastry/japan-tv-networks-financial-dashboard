# 📊 Japan 5 Commercial TV Networks Financial Analysis Dashboard (FY2015–FY2026)
...
* **📸 One-Click Image Export**: Save high-resolution PNG chart images pre-formatted with titles for presentations and executive reports.
* **🚀 Zero-Dependency & Offline Ready**: Fully self-contained single-file HTML architecture requiring no server, npm build, or external API dependencies.

---

## 📊 Analytical Revenue Categories

1. **TV Broadcasting > Terrestrial, BS, CS, etc.** (Time, Spot, Program Sales)
2. **TV Broadcasting > Digital Ads** (TVer, FOD, AVOD streaming ad revenues)
3. **Content, Streaming, Production & IP** (Rights sales, SVOD, Movie, Anime IP)
4. **Merchandising & Lifestyle** (PLAZA, Direct Sales, Mail Order, Education)
5. **Wellness** (Fitness clubs, sports facilities)
6. **Real Estate & Others** (Urban development, building lease, hotels)
7. **Others** (Miscellaneous segment revenues)
